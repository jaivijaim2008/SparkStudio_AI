...
async def export_project(
    ...
    if format == "zip":
        zip_bytes = ExportService.generate_zip_package(
            project_data,
            include_subtitles=(subtitles.lower() == "true"),
            include_storyboard=(storyboard.lower() == "true")
        )
...
async def generate_scene_image(body: ImageGenerateRequest):
    ...
    if hf_token:
        try:
            hf_url = "https://router.huggingface.co/hf-inference/models/runwayml/stable-diffusion-v1-5"
