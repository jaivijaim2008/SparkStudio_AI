...
export default function DashboardLayout({
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-100 dark:bg-[#0a0a0f] text-slate-900 dark:text-slate-100 transition-colors duration-200">
      {/* Sidebar */}
      <aside className="w-64 border-r border-slate-300 dark:border-white/10 bg-white dark:bg-[#0f0f17] flex flex-col transition-colors duration-200">
        <div className="p-6">
              ...
              >
                {isActive && (
                  <motion.div
                    ...
                    className="absolute inset-0 bg-purple-100 dark:bg-purple-600/20 rounded-xl border border-purple-300 dark:border-purple-500/40"
                    initial={false}
      ...
      {/* Main Content */}
      <main className="flex-1 overflow-y-auto relative bg-slate-100 dark:bg-[#0a0a0f] transition-colors duration-200">
