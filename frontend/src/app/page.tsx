          ...
          {[
            {
              ...
              features: ['5 projects / day', 'All 9 AI agents', 'Standard Generation Queue', 'Educational Content Tone'],
              cta: 'Get Started',
              featured: false,
            },
            {
              ...
              features: ['Unlimited projects', 'Priority Generation Queue', 'Advanced Content Tones', 'ZIP File Export'],
              cta: 'Upgrade to Pro',
              featured: true,
            },
            {
              ...
              features: ['Everything in Pro', 'Advanced Creator Analytics', 'Multiple Brand Personas', 'PDF & Markdown Exports'],
              cta: 'Contact Sales',
              featured: false,
            },
          ].map((plan, idx) => (
